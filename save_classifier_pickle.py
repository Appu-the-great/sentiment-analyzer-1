...
print("Navive Bayes Algo accuracy %:", (nltk.classify.accuracy(classifer, testing_set))*100)
classifer.show_most_informative_features(15)

# save_classifer = open("naviebayes.pickle", "wb")
# pickle.dump(classifer, save_classifer)
